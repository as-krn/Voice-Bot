...
with open('C:/Users/ahmtk/PycharmProjects/VoiceBot/intro_join.txt','r', encoding='utf8', errors ='ignore') as fin:
    raw = fin.read().lower()
...
file = "file.mp3"
flag=True
fst="My name is VoiceBot. I will answer your queries about Science. If you want to exit, say Bye"
...
while (flag == True):
    ...
    if (clas != 'Bye'):
        if (clas == 'Emotion'):
            flag = False
            prYellow("VoiceBot: You are welcome..")
        else:
            if (greeting(user_response) != None):
                print("\033[93m {}\033[00m".format("VoiceBot: " + greeting(user_response)))
            else:
                print("\033[93m {}\033[00m".format("VoiceBot: ", end=""))
        ...
        flag = False
        prYellow("VoiceBot: Bye! take care..")